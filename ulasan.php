  ...
  <div class="happy-clients section">
    <div class="container">
      <div class="row">
        ...
        // Query SQL untuk mengambil satu baris buku dari tabel buku
        $sql = "SELECT buku.id_buku, buku.judul_buku, buku.nama_penulis, buku.gambar, AVG(ulasan.rating) AS rating_rata
                FROM buku
