          ...
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Daftar Penerbit</li>
              </ol>
            </nav>
          </div>
          <div class="row">
                ...
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <div>
                      ...
                      <p class="card-description">Data Penerbit</p>
                    </div>
                    <div class="text-right">
                      <a href="tambah_penerbit.php" class="btn btn-primary btn-sm">Tambah Penerbit</a>
                    </div>
                  </div>
                  <?php
                  include '../../../koneksi.php';
                  ...
                  $sql_artikel = "SELECT * FROM penerbit";
                    ...
                    <tbody>
                      ...
                      if ($result_artikel) {
                        ...
                        while ($row_artikel = mysqli_fetch_assoc($result_artikel)) {
                          ...
                          echo "<tr>";
                          echo "<td>" . $no . "</td>";
                          echo "<td>" . $row_artikel['nama_penerbit'] . "</td>";
                          echo "<td>" . $row_artikel['tentang'] . "</td>";
                          echo "<td>" . $row_artikel['alamat'] . "</td>";
                          echo "<td>
                            <a href='edit_penerbit.php?id_penerbit=" . $row_artikel['id'] . "' class='btn btn-warning btn-sm'>Edit</a>
                            <a href='proses_hapus_penerbit.php?id_penerbit=" . $row_artikel['id'] . "' class='btn btn-danger btn-sm' onclick='return confirm(\"Apakah Anda yakin ingin menghapus?\")'>Hapus</a>
                            ...
                            <div class='modal-dialog modal-lg' role='document'>
                              <div class='modal-content'>
                                <div class='modal-header'>
                                  <h5 class='modal-title' id='detailModalLabel$no'>Detail Penerbit</h5>
                                  <button type='button' class='close' data-dismiss='modal' aria-label='Close'>
                                    <span aria-hidden='true'>&times;</span>
                                  </button>
                                </div>
                                <div class='modal-body'>
                                  <p><strong>Nama Penerbit:</strong> {$row_artikel['nama_penerbit']}</p>
                                  <p><strong>Tentang:</strong> {$row_artikel['tentang']}</p>
                                  <p><strong>Alamat:</strong> {$row_artikel['alamat']}</p>
                                </div>
