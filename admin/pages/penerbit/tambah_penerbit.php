                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description">
                            Formulir untuk menambah data Penerbit
                        </p>
                        <form action="proses_tambah_penerbit.php" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="judul_penerbit">Nama Penerbit</label>
                                <input type="text" class="form-control" id="judul_penerbit" name="judul_penerbit" placeholder="Nama Penerbit" required>
                            </div>
                            <div class="form-group">
                                <label for="tentang">Tentang Penerbit</label>
                                <input type="text" class="form-control" id="tentang" name="tentang" placeholder="Tentang" required>
                            </div>
                            <div class="form-group">
