                    ...
                    <tbody>
                      ...
                      if ($result_artikel) {
                        ...
                        while ($row_artikel = mysqli_fetch_assoc($result_artikel)) {
                          ...
                          echo "<tr>";
                          echo "<td>" . $no . "</td>";
                          echo "<td>" . $row_artikel['judul_artikel'] . "</td>";
                          echo "<td>" . $row_artikel['sumber'] . "</td>";
                          echo "<td>" . $row_artikel['penulis'] . "</td>";
                            ...
                            <div class='modal-dialog modal-lg' role='document'>
                              <div class='modal-content'>
                                <div class='modal-header'>
                                  <h5 class='modal-title' id='detailModalLabel$no'>Detail Artikel</h5>
                                  <button type='button' class='close' data-dismiss='modal' aria-label='Close'>
                                    <span aria-hidden='true'>&times;</span>
                                  </button>
                                </div>
                                <div class='modal-body'>
                                  <p><strong>Judul Artikel:</strong> {$row_artikel['judul_artikel']}</p>
                                  <p><strong>Sumber:</strong> {$row_artikel['sumber']}</p>
                                  <p><strong>Penulis:</strong> {$row_artikel['penulis']}</p>
                                  <p><strong>Tanggal:</strong> {$row_artikel['tanggal']}</p>
